...
namespace VirtualZooManagementSystem {
    ...
    public partial class animalsDataSet : global::System.Data.DataSet {
        ...
        public partial class animalsDataTable : global::System.Data.TypedTableBase<animalsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public animalsRow AddanimalsRow(string Name, int Age, string AnimalType) {
...
namespace VirtualZooManagementSystem.animalsDataSetTableAdapters {
    ...
    public partial class animalsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[animals] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_" +
                "Name) AND ([Age] = @Original_Age) AND ([AnimalType] = @Original_AnimalType))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[animals] ([Name], [Age], [AnimalType]) VALUES (@Name, @Age, @A" +
                "nimalType);\r\nSELECT ID, Name, Age, AnimalType FROM animals WHERE (ID = SCOPE_IDE" +
                "NTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[animals] SET [Name] = @Name, [Age] = @Age, [AnimalType] = @AnimalType WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Age] = @Original_Age) AND ([AnimalType] = @Original_AnimalType));
SELECT ID, Name, Age, AnimalType FROM animals WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::VirtualZooManagementSystem.Properties.Settings.Default.animalsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Age, AnimalType FROM dbo.animals";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT ID, Name, Age, AnimalType FROM dbo.animals";
        ...
        public virtual int FillBy(animalsDataSet.animalsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Name, int Original_Age, string Original_AnimalType) {
            ...
            if ((Original_AnimalType == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_AnimalType));
            }
        ...
        public virtual int Insert(string Name, int Age, string AnimalType) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, int Age, string AnimalType, int Original_ID, string Original_Name, int Original_Age, string Original_AnimalType, int ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            if ((Original_AnimalType == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_AnimalType));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Age, string AnimalType, int Original_ID, string Original_Name, int Original_Age, string Original_AnimalType) {
            return this.Update(Name, Age, AnimalType, Original_ID, Original_Name, Original_Age, Original_AnimalType, Original_ID);
        }
    }
